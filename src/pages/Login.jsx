...
import { Container, Button, Paper, TextField, Typography, Stack, Avatar, IconButton } from '@mui/material';
...
const Login = () => {
    ...
    const toggleLogin = () => {
        setIsLogin((prev) => !prev); // Toggling the state between true and false
    };
                        ...
                        {isLogin ? (
                            <>
                                ...
                                >
                                    ...
                                    <Typography variant='body1' style={{ textAlign: "center", margin: "1rem" }} >Or</Typography>
                                    <Button
                                        sx={{
                                            marginTop: "1rem",
                                        }}
